...
<form action="{{ route('aide_soignant.statAccouchement')}}" method="get">
...
<form action="{{ route('medecin.statistiques')}}" method="get">
  ...
  borderColor = config.colors.borderColor;
    ...
    orderChartConfig = {
      ...
      series: [{{ (($nbrNaissances-$nbrDeces)/($nbrNaissances+$nbrDeces == 0 ? 1 : $nbrNaissances+$nbrDeces))*100 }}, {{ ($nbrDeces/($nbrNaissances+$nbrDeces == 0 ? 1 : $nbrNaissances+$nbrDeces))*100 }}],
