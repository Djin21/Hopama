...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4">Fil d'attente</h4>
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        ...
                        data-bs-html="true"
                        data-bs-content="<a class='dropdown-item' data-bs-toggle='modal' data-bs-target='#modalResultat{{$paiement->id}}'><i class='bx bx-edit-alt me-1'></i> Examiner</a>" 
                        title=""
                      >
                              ...
                              <div class="modal-body">
                                <div class="row g-md-2 mb-4">
                                  <div class="col mb-0 text-start">
                                    <textarea class="form-control" name="resultat" id="resultat" cols="30" rows="10"></textarea>
                                  </div>
                                </div>
                              </div>
