      ...
      <div class="tab-content p-0">
        <div class="card tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
          ...
          <div class="table-responsive text-nowrap">
            <table class="table">
              <caption class="ms-4">
                Nombre de maladies : {{ $maladies->count() }}
              </caption>
              <thead>
                <tr>
...
<div class="space-impression" style="position: fixed; bottom:0; right:0;">
  <a href="{{ route('admin.impressionStatDiagnostique') }}" class="btn btn-primary me-3 mb-3 shadow-lg" style="color: white;">Imprimer <i class="bi bi-print"></i> </a>
</div>
