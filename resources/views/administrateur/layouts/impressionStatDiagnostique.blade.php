...
<body>
    <div class="container mt-5">
        <div class="row ps-4 d-flex">
            <a href="{{ route('admin.statDiagnostique') }}" class="btn btn-outline- w-auto">Precedent</a>
            <button class="btn btn-primary w-auto" onclick="impression()">Imprimer</button>
        </div>
        <div class="row px-5" id="table">
            <h3 class="mt-4 mb-2 text-center">Liste des maladies diagnostiquées</h3>
            <table class="table table-bordered mb-5 mt-5" style="background-color: white;">
                <thead>
