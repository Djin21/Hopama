    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row g-md-2 mb-4">
            <div class="col mb-0 text-start">
              <textarea class="form-control" name="symptomes" id="symptomes" cols="30" rows="10" disabled>{{ $consultation->symptomes != Null ? $consultation->symptomes : '' }}</textarea>
            </div>
          </div>
        </div>
        <div class="modal-footer">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row g-md-2 mb-4">
            <div class="col mb-0 text-start">
              <textarea class="form-control" name="notes" id="notes" cols="30" rows="10" disabled>{{ $consultation->notes == Null ? '' : $consultation->notes }}</textarea>
            </div>
          </div>
        </div>
        <div class="modal-footer">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row g-md-2 mb-4">
            <div class="col mb-0 text-start">
              <textarea class="form-control" name="ordonnance" id="ordonnance" cols="30" rows="10" disabled>{{ $prescription->ordonnance == Null ? '' : $prescription->ordonnance }}</textarea>
            </div>
          </div>
        </div>
        <div class="modal-footer">
