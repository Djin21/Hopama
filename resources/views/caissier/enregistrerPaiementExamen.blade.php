...
<?php $test = "Salut a toi"; ?>
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <form method="POST" action="{{ route('caisse.examenPaiement.save') }}">
        @csrf
    ...
    <script>
      ...
      $('div.moi').load("/caisse/loadListeExamen/all", function(){});
      ...
      function voila(){
        $('div.moi').load("/caisse/loadListeExamen/" + c.val(), function() {
          state = 0;
        });
      }
    </script>
