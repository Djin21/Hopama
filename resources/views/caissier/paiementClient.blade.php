...
<?php $test = "Salut a toi"; ?>
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4">Nouvel session</h4>
              ...
              <ul class="nav nav-tabs nav-fill" role="tablist">
                <li class="nav-item align-items-center">
                  <button
                    ...
                    onclick="erase2()"
                  >
                    <i class="tf-icons bx bx-user"></i> Client
                  </button>
                </li>
                <li class="nav-item">
                  <button
                    ...
                    onclick="erase1()"
                  >
                    <i class="tf-icons bx bx-message-square"></i> Patient
                  </button>
                </li>
              </ul>
