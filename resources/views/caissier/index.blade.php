              ...
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    ...
                    <a href="{{ route('caisse.paiementClient') }}" class="btn btn-sm btn-outline-primary">Nouveau</a>
                  </div>
                </div>
                    ...
                    <div class="card-title d-flex align-items-start justify-content-between">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                          <a class="dropdown-item" href="{{ route('caisse.historique') }}">Voir plus</a>
                        </div>
                      </div>
                    </div>
                    <span class="fw-semibold d-block mb-1">Sessions</span>
                    <h3 class="card-title mb-2">{{ $prixConsultation }} FCFA</h3>
                    ...
                    <div class="card-title d-flex align-items-start justify-content-between">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                          <a class="dropdown-item" href="{{ route('caisse.examenListe') }}">Voir plus</a>
                        </div>
                      </div>
                    </div>
                    <span>Examens</span>
