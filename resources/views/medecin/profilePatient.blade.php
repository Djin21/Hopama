    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="row">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center">
                            ...
                            <button type="submit" class="btn btn-primary mx-auto d-none" data-bs-toggle="modal" data-bs-target="#modalCenter">Mises a jour</button>
        ...
        <div class="col-xxl row">
            ...
            <button type="submit" class="btn btn-primary ms-auto mt-2 d-none" data-bs-toggle="modal" data-bs-target="#defineConsulationModal" style="width: auto;">Nouvelle consultation</button>
            <button type="submit" class="btn ms-auto mt-2" style="width: auto; background-color: white; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.089);" data-bs-toggle="modal" data-bs-target="#listConsulationModal">Voir plus</button>
            <form action="{{ route('aide_soignant.profile_patient', ['idPatient' => $patient->id]) }}" method="post">
