...
@section('content')
    ...
    <script>
      ...
      setInterval(() => {
        if($('.searchexam').val() == ''){
          if(state == 0){
            $('#tout').load("/medecin/listAll/all", function(){});
            $('#suivit').load("/medecin/listSuivit/all", function(){});
            $('#hospitalisee').load("/medecin/listHospitalisee/all", function(){});
            state = 1;
          }
        }
      }, 500);
      ...
      function voila(){
        $('#tout').load("/medecin/listAll/"+ c.val(), function(){
          state = 0;
        });
        $('#suivit').load("/medecin/listSuivit/"+ c.val(), function(){
          state = 0;
        });
        $('#hospitalisee').load("/medecin/listHospitalisee/"+ c.val(), function(){
          state = 0;
        });
      }
  </script>
